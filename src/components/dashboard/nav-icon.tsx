import {
  ...
  CalendarDays, Clock, Plane, Receipt, CreditCard, Wallet, Banknote, Truck, Wrench, BarChart3, Settings, Utensils, MessageSquare,
} from "lucide-react";
...
const MAP: Record<NavItem["icon"], React.ComponentType<{ className?: string }>> = {
  ...
  equipment: Wrench, reports: BarChart3, settings: Settings, vouchers: Utensils, messages: MessageSquare,
};
