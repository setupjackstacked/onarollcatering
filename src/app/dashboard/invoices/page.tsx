  ...
  return (
    <>
      ...
      <div className="mb-6 grid grid-cols-2 gap-3 md:grid-cols-3">
        <Metric label="Outstanding" value={formatGBP(summary.outstanding, { showPence: false })} hint={`${summary.count} invoice${summary.count === 1 ? "" : "s"}`} />
        <Metric label="Overdue" value={formatGBP(summary.overdue, { showPence: false })} tone={summary.overdue > 0 ? "warning" : "default"} />
      </div>
