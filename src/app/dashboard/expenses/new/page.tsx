...
export default async function NewExpensePage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return (
    <div className="max-w-3xl">
      ...
      <ExpenseForm projects={projects} suppliers={[]} canApprove={ctx.can("finance.write")} defaults={{ project_id: str(sp.project) || undefined, expense_date: isoDateOffset(0) }} returnTo={ret || undefined} />
    </div>
  );
}
