    ...
    <div className="max-w-3xl">
      ...
      {employees.length ? (
        <ShiftForm employees={employees} projects={projects} sites={sites} roles={roles.map((r) => ({ value: r.key, label: r.label }))} returnTo={ret}
          defaults={{ shift_date: str(sp.date) || isoDateOffset(0), employee_id: str(sp.employee) || undefined, project_id: str(sp.project) || undefined, site_id: str(sp.site) || undefined }} />
      ) : (
